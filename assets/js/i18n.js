...
const I18N = {
  fr: {
    ...
    legal: "Beaulieu Pizza — Entreprise individuelle. Siège social : 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer. SIRET : à compléter. Directeur de la publication : à compléter. Hébergement : à compléter. Ce site ne collecte aucune donnée de paiement ; toute commande s’effectue par téléphone.",
  },
  ...
  en: {
    ...
    legal: "Beaulieu Pizza — Sole proprietorship. Registered office: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, France. Company registration number: to be completed. Publication director: to be completed. Hosting: to be completed. This site collects no payment data; all orders are placed by phone.",
  },
  ...
  es: {
    ...
    legal: "Beaulieu Pizza — Empresa individual. Domicilio social: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, Francia. Número de registro: por completar. Director de publicación: por completar. Alojamiento: por completar. Este sitio no recopila ningún dato de pago; todos los pedidos se realizan por teléfono.",
  },
  ...
  it: {
    ...
    legal: "Beaulieu Pizza — Impresa individuale. Sede legale: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, Francia. Numero di registrazione: da completare. Direttore della pubblicazione: da completare. Hosting: da completare. Questo sito non raccoglie alcun dato di pagamento; tutti gli ordini si effettuano per telefono.",
  },
  ...
  ru: {
    ...
    legal: "Beaulieu Pizza — Индивидуальное предприятие. Юридический адрес: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, Франция. Регистрационный номер: уточняется. Директор публикации: уточняется. Хостинг: уточняется. Сайт не собирает платёжные данные; все заказы оформляются по телефону.",
  },
};
