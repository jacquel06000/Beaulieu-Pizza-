...
const I18N = {
  fr: {
    ...
    legal: "H.O.P (SARL), exploitant sous l’enseigne « Beaulieu Pizza ». Gérant : Harold Gardet. Siège social : 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer. SIRET : 812 512 952 00019. N° TVA intracommunautaire : FR66 812 512 952. Téléphone : 04 93 01 00 51. Directeur de la publication : Harold Gardet, gérant. Hébergement : Hostinger International Ltd, 61 Lordou Vironos Street, 6023 Larnaca, Chypre. Ce site ne collecte aucune donnée de paiement ; toute commande s’effectue par téléphone. Conception et réalisation du site : Alexandre Jacquel.",
  },
  ...
  en: {
    ...
    legal: "H.O.P (SARL, French limited liability company), trading as “Beaulieu Pizza”. Manager: Harold Gardet. Registered office: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, France. Company registration number (SIRET): 812 512 952 00019. Intra-EU VAT number: FR66 812 512 952. Phone: 04 93 01 00 51. Publication director: Harold Gardet, manager. Hosting: Hostinger International Ltd, 61 Lordou Vironos Street, 6023 Larnaca, Cyprus. This site collects no payment data; all orders are placed by phone. Site design: Alexandre Jacquel.",
  },
  ...
  es: {
    ...
    legal: "H.O.P (SARL, sociedad de responsabilidad limitada francesa), que opera bajo el nombre comercial «Beaulieu Pizza». Gerente: Harold Gardet. Domicilio social: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, Francia. Número de registro (SIRET): 812 512 952 00019. Número de IVA intracomunitario: FR66 812 512 952. Teléfono: 04 93 01 00 51. Director de publicación: Harold Gardet, gerente. Alojamiento: Hostinger International Ltd, 61 Lordou Vironos Street, 6023 Larnaca, Chipre. Este sitio no recopila ningún dato de pago; todos los pedidos se realizan por teléfono. Diseño del sitio: Alexandre Jacquel.",
  },
  ...
  it: {
    ...
    legal: "H.O.P (SARL, società a responsabilità limitata francese), operante con il nome commerciale «Beaulieu Pizza». Gerente: Harold Gardet. Sede legale: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, Francia. Numero di registrazione (SIRET): 812 512 952 00019. Partita IVA intracomunitaria: FR66 812 512 952. Telefono: 04 93 01 00 51. Direttore della pubblicazione: Harold Gardet, gerente. Hosting: Hostinger International Ltd, 61 Lordou Vironos Street, 6023 Larnaca, Cipro. Questo sito non raccoglie alcun dato di pagamento; tutti gli ordini si effettuano per telefono. Design del sito: Alexandre Jacquel.",
  },
  ...
  ru: {
    ...
    legal: "H.O.P (SARL, французское общество с ограниченной ответственностью), торговое название «Beaulieu Pizza». Управляющий: Harold Gardet. Юридический адрес: 11 Bd du Maréchal Joffre, 06310 Beaulieu-sur-Mer, Франция. Регистрационный номер (SIRET): 812 512 952 00019. Номер плательщика НДС в ЕС: FR66 812 512 952. Телефон: 04 93 01 00 51. Директор публикации: Harold Gardet, управляющий. Хостинг: Hostinger International Ltd, 61 Lordou Vironos Street, 6023 Larnaca, Кипр. Сайт не собирает платёжные данные; все заказы оформляются по телефону. Дизайн сайта: Alexandre Jacquel.",
  },
};
